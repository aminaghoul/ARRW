...
```{r}
res1 <- var1(val, sdNu, 10)
maxi <- max(res1$variance)
ggplot(res1) + ggtitle("Variance de l'estimateur du modèle marche aléatoire plus bruit") + geom_point(aes(x = i, y = variance))+ylim(0,maxi)
```
